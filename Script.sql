...
BEGIN
    ...
    VALUES (DEPARTURE_POINT_ID, ARRIVAL_POINT_ID, DISTANCE, DURATION);
    COMMIT;
    RESULT := 1;
EXCEPTION
    WHEN OTHERS THEN
...
CREATE OR REPLACE PROCEDURE INSERT_STATION_ROUTE(
...
IS
BEGIN
    UPDATE VANS SET "TYPE" = TYPE_IN, CAPACITY = CAPACITY_IN,
